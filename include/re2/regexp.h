...
class Regexp {
 public:
  ...
  // form LeftParen regexp VerticalBar regexp VerticalBar ... regexp
  // VerticalBar. The parser pops all this off the stack and creates an
  // alternation of the regexps (DoAlternation).
