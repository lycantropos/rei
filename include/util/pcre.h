...
class PCRE {
 public:
  ...
  // You can pass in a "const char*" or a "std::string" or a "PCRE" for
  // "pattern".
  //
 ...
 private:
  ...
  int TryMatch(const StringPiece& text, size_t startpos, Anchor anchor,
  ...
  bool DoMatchImpl(const StringPiece& text, Anchor anchor, size_t* consumed,
